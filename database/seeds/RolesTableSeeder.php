...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user_co = new Role();
        $user_co->name = 'company';
        $user_co->display_name = 'Insurance Company';
        $user_co->description = 'A user who manages the insurance company account';
        $user_co->save();

        $user_officer = new Role();
        $user_officer->name = 'officer';
        $user_officer->display_name = 'Police Officer';
        $user_officer->description = 'A user who has police officer account';
        $user_officer->save();
