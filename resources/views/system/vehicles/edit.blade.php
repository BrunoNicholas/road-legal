...
<div class="row">
  	<div class="col-md-9">
        <form method="post" action="{{ route('vehicles.update', $vehicle->id) }}" autocomplete="off" class="form-horizontal">
            @csrf
            {{ method_field('PATCH') }}
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <select class="selectpicker col-sm-12 pl-0 pr-0" name="car_owner_id" data-style="select-with-transition" title="" data-size="100">
                                  <option value="{{ $vehicle->car_owner_id }}">Change Policy Owner</option>
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <select class="selectpicker col-sm-12 pl-0 pr-0" name="company_id" data-style="select-with-transition" title="" data-size="100">
                                    <option value="{{ $vehicle->company_id }}">Select company (Change or leave)</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-control">
                                ...
                                <input class="" input type="radio" name="car_category" value="{{ $vehicle->car_category }}" id="input-st1" value="Company Owned" /><label for="input-st1">Company Owned (Fleet)</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" name="car_model" value="{{ $vehicle->car_model }}" id="input-car_model" type="text" placeholder="Model/Make of the Vehicle" value="" required aria-required="true" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" name="reg_no" value="{{ $vehicle->reg_no }}" id="input-reg_no" type="text" placeholder="Car Registration Number" value="" required />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">
                              <input class="form-control" input type="text" value="{{ $vehicle->policy_no }}" name="policy_no" id="input-policy_no" placeholder="Car policy number" />
                          </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" input type="text" value="{{ $vehicle->no_plate }}" name="no_plate" id="input-no_plate" placeholder="Vehicle number plate" />
                            </div>
                         </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">
                              <input class="form-control" input type="number" value="{{ $vehicle->seating_capacity }}" name="seating_capacity" id="input-seating_capacity" placeholder="Seating Capacity" />
                          </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" input type="number" value="{{ $vehicle->gross_weight }}" name="gross_weight" id="input-gross_weight" placeholder="Gross weight" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" input type="number" value="{{ $vehicle->car_price }}" name="car_price" id="input-car_price" placeholder="Vehicle price" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" input type="number" value="{{ $vehicle->premium_charged }}" name="premium_charged" id="input-premium_charged" placeholder="Premium charged" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">
                              <input class="form-control" input type="text" name="price_units" value="{{ $vehicle->price_units }}" id="input-price_units" placeholder="Price units (UGX, USD)" />
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">
                              <input class="form-control" input type="text" value="{{ $vehicle->issuing_authority }}" name="issuing_authority" id="input-issuing_authority" placeholder="Authority issuing " />
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                          <div class="form-group">
                              <input class="form-control" input type="date" value="{{ $vehicle->date_of_issue }}" name="date_of_issue" id="input-date_of_issue" placeholder="" />
                          </div>
                      </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <input class="form-control" input type="date" name="date_of_expiry" id="input-date_of_expiry" placeholder="" value="{{ $vehicle->date_of_expiry }}" />
                            </div>
                        </div>
                    </div>
                </div>
            <div class="card-footer ml-auto mr-auto">
                    <button type="submit" class="btn btn-success"><i class="material-icons">done</i> UPDATE MTP </button>
                </div>
            </div>
        </form>
    </div>
